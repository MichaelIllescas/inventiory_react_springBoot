...
const AplicarDescuentos: React.FC = () => {
  // Estados
  ...
  const [porcentajeDescuento, setPorcentajeDescuento] = useState<number>(1);
  ...
  const aplicarDescuento = () => {
    setProductosSeleccionados(
      productosSeleccionados.map((producto) => ({
        ...producto,
        precio: producto.precio - (producto.precio * porcentajeDescuento) / 100,
      }))
    );
    setConfirmationMessage("El descuento se aplicó correctamente.");
  };
    ...
    <div className="content">
      ...
      <div className="bg-index container-fluid py-1">
        <div className="typing-container titulo-main">
          <h1 className="typing-text text-center">Aplicar Descuentos a Productos</h1>
        </div>
        <div className="container mt-0 pt-0 pb-5">
          <div className="row">
            <div className="col-md-6 offset-md-3">
              <div className="bg-white p-3 rounded-2 shadow-lg">
                <h5 className="card-header">Descuentos en Productos:</h5>
                <div className="card-body">
                  ...
                  <div className="form-group">
                    <label htmlFor="buscarProducto" className="p-1">Buscar Producto:</label>
                    <input
                      type="text"
                      id="buscarProducto"
                  ...
                  <div className="col-lg-12">
                    ...
                    {/* Formulario para confirmar el descuento */}
                    <form
                      onSubmit={(e) => {
                        e.preventDefault();
                        aplicarDescuento();
